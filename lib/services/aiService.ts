...
const PRODUCT_IMAGE_MAP: Array<{ keywords: string[]; url: string }> = [
  { keywords: ['đèn chiếu', 'bầu trời sao', 'galaxy', 'projector', 'ngân hà'], url: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=600&h=600&fit=crop&q=90' },
  { keywords: ['đèn ngủ', 'mặt trăng', '3d', 'đèn trang trí'], url: 'https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=600&h=600&fit=crop&q=90' },
  { keywords: ['cây', 'bonsai', 'kim ngân', 'sen đá', 'cây cảnh', 'chậu cây', 'tiểu cảnh'], url: 'https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=600&h=600&fit=crop&q=90' },
  { keywords: ['khăn', 'khăn choàng', 'lụa', 'khăn len', 'tơ tằm'], url: 'https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=600&h=600&fit=crop&q=90' },
  { keywords: ['đĩa than', 'vinyl', 'đài', 'radio', 'máy phát nhạc'], url: 'https://images.unsplash.com/photo-1539185441755-769473a23570?w=600&h=600&fit=crop&q=90' },
  { keywords: ['ấm trà', 'trà hoa', 'trà cúc', 'tách trà', 'trà đạo'], url: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=600&h=600&fit=crop&q=90' },
  { keywords: ['gối', 'gối cao su', 'gối massage', 'giấc ngủ', 'đệm cổ'], url: 'https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=600&h=600&fit=crop&q=90' },
  { keywords: ['album', 'ảnh dán', 'kỷ niệm', 'handmade album'], url: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=600&h=600&fit=crop&q=90' },
  { keywords: ['thớt', 'thớt gỗ', 'đồ dùng bếp', 'khay gỗ'], url: 'https://images.unsplash.com/photo-1590794056226-77ef3a6c4743?w=600&h=600&fit=crop&q=90' },
  { keywords: ['cốc', 'ly', 'ly sứ', 'cốc đôi'], url: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=600&h=600&fit=crop&q=90' },
  { keywords: ['vòng tay', 'lắc tay', 'bạc s925', 'bạc'], url: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&h=600&fit=crop&q=90' },
  { keywords: ['dây chuyền', 'vàng 18k', 'kim cương', 'nhẫn', 'trang sức', 'jewelry'], url: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=600&h=600&fit=crop&q=90' },
  { keywords: ['son', 'lip', 'romand', 'tint', 'makeup', 'son môi'], url: 'https://images.unsplash.com/photo-1586495777744-4e6b0864a597?w=600&h=600&fit=crop&q=90' },
  ...
  { keywords: ['nến', 'nến thơm', 'candle', 'diptyque', 'yankee'], url: 'https://images.unsplash.com/photo-1602523961358-f9f03dd557db?w=600&h=600&fit=crop&q=90' },
...
export class AIService {
  ...
  static async getOnlineProducts(
    ...
    const cacheKey = `products_${keyword.toLowerCase().trim()}_${giftName.toLowerCase().trim()}_${(targetPriceRange || '').trim()}`;
...
${targetPriceRange ? `Tầm giá dự kiến: "${targetPriceRange}"` : ''}
...
${targetPriceRange ? `4. Mức giá sản phẩm PHẢI nằm đúng trong tầm giá "${targetPriceRange}" (hoặc phân bổ hợp lý xung quanh dải giá này).` : ''}
